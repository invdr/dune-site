...
- Concrete VPS deployment config lives in `deploy/docker-compose.prod.yml`, `deploy/Dockerfile.web`, `deploy/Caddyfile`, and `deploy/.env.prod.example`; update README/docs alongside those files.
